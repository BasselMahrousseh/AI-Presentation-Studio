...
function Brand({ compact = false }: { compact?: boolean }) {
  return <div className={cn("flex items-center gap-2.5", compact && "gap-2")}><div className="brand-mark"><Presentation size={16} strokeWidth={2.5} /></div><span className="font-semibold tracking-[-0.02em] text-slate-900">{compact ? "Studio" : "Presentation Studio"}</span></div>;
}
    ...
    <main className="flex flex-1 items-center justify-center bg-[#f8fafc] px-5 py-16">
      <div className="w-full max-w-[530px] text-center">
        <div className="generation-orb">
          <div className="generation-orb-inner">
            <Sparkles size={24} />
          </div>
        </div>

        <p className="mt-7 text-[11px] font-semibold uppercase tracking-[0.18em] text-[#4779e8]">
          Building your deck
        </p>

        <h1 className="mt-2 text-[28px] font-semibold tracking-[-0.04em] text-slate-900">
        ...
        <div className="mt-9 rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
          <div className="flex items-center justify-center gap-3">
            <div className="h-3 w-3 animate-pulse rounded-full bg-[#4779e8]" />
