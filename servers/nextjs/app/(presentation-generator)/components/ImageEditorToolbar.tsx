  ...
  return (
    <div className="inline-flex items-center gap-3 rounded-[6px] bg-white px-[10px] py-[6px] shadow-[0_0_4px_rgba(0,0,0,0.15)]">
          ...
          {FIT_OPTIONS.map((option) => (
            <DropdownMenuItem
              ...
              className={cn(
                ...
                objectFit === option.value && "bg-brand-tint text-brand",
              )}
            >
              {option.label}
            </DropdownMenuItem>
      ...
      <div className="inline-flex items-center gap-3">
        <button
          ...
          className={cn(
            ...
            objectFit === "cover" && "bg-brand-tint text-brand",
          )}
        >
        ...
        <button
          ...
          className={cn(
            "rounded-[2px] p-1 text-[#191919] hover:bg-[#F8F8FA]",
            objectFit === "contain" && "bg-brand-tint text-brand",
          )}
        >
        ...
        <button
          ...
          className={cn(
            "rounded-[2px] p-1 text-[#191919] hover:bg-[#F8F8FA]",
            objectFit === "fill" && "bg-brand-tint text-brand",
          )}
        >
      ...
      <button
        ...
        className={cn(
          "rounded-[2px] p-1 text-[#191919] hover:bg-[#F8F8FA]",
          isFocusPointMode && "bg-brand-tint text-brand",
        )}
      >
