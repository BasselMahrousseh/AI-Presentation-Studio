...
function PresentationIconButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "flex size-[18px] shrink-0 items-center justify-center text-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#e60000] focus-visible:ring-offset-4 focus-visible:ring-offset-[#1A1B20]",
        active ? "text-[#e60000]" : "hover:text-[#E6E6E6]",
      ...
      >
        <div
          className={cn(
            ...
            isActive
              ? "shadow-[0_0_0_2px_#e60000]"
              : "shadow-[0_0_0_1px_rgba(76,76,76,0)] group-hover:shadow-[0_0_0_1px_#4C4C4C] group-focus-visible:shadow-[0_0_0_2px_#e60000]"
          )}
    ...
    >
      ...
      {showSlideGrid ? (
        <div className="absolute inset-0 overflow-hidden bg-black">
          <button
            type="button"
            className="presentation-controls absolute right-5 top-5 z-50 rounded-[48px] border border-[#4C4C4C] px-5 py-2.5 text-[14px] font-semibold leading-none tracking-[-0.14px] text-white transition-colors hover:border-[#E6E6E6] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#e60000]"
            onClick={(event) => {
              event.stopPropagation();
              setShowSlideGrid(false);
            }}
        ...
        <>
            ...
            {slides.map((slide, index) => (
              <div
                ...
                className={cn(
                  ...
                  index <= activeSlideIndex ? "bg-[#e60000]" : "bg-[#323436]"
                )}
              />
            ))}
          </div>
          ...
          {notesPanelOpen ? (
            <aside className="presentation-controls absolute bottom-0 right-0 top-0 z-50 w-full border-l border-[#333333] bg-black md:w-[302px]">
              <button
                type="button"
                className="absolute right-5 top-5 rounded-[48px] border border-[#4C4C4C] px-5 py-2.5 text-[14px] font-semibold leading-none tracking-[-0.14px] text-white transition-colors hover:border-[#E6E6E6] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#e60000]"
                onClick={(event) => {
                  event.stopPropagation();
                  setShowSpeakerNotes(false);
                }}
