...
class ExportTaskService:
    ...
    async def _run_task_locked(self, task_payload: dict, response_error_detail: str) -> dict:
        print("Debug 9.4.3.2.1.1")

        self._ensure_runtime_ready()
        print("Debug 9.4.3.2.1.2")
        temp_dir, task_path, response_path = self._create_task_paths()

        try:
            print("Debug 9.4.3.2.1.3")
    ...
    async def _run_bounded_child(
        ...
        *,
        ...
        print("Debug run_bounded_child 1")
        stdout_tail = BoundedTextBuffer()
        stderr_tail = BoundedTextBuffer()
        print("Debug run_bounded_child 2")
        print("Event loop:", type(asyncio.get_running_loop()))
        print("Event loop policy:", type(asyncio.get_event_loop_policy()))
        ...
        print("Debug run_bounded_child 3")
