...
REVISION_SMART_TEMPLATE = "e4a6c8d0f2b1"
REVISION_SMART_BRAND_COLORS = "a8c2e4f6b1d3"
REVISION_GENERATION_STATUS = "b1e3a5c7d9f2"
REVISION_HAS_EXPLICIT_SLIDE_STRUCTURE = "8aa26640d3e8"
REVISION_HEAD = REVISION_HAS_EXPLICIT_SLIDE_STRUCTURE
...
def _infer_revision_from_schema(
    ...
    if "provider_settings" in tables and "user" in tables and ownership_ready:
        if "presentations" in tables and _has_column(
            ...
            return REVISION_SMART_TEMPLATE
