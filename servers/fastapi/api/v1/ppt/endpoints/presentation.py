...
async def _stream_smart_presentation(
    ...
    logger.info(
        "[smart-workflow] smart_stream_start presentation_id=%s stored_slides=%s files=%s web_search=%s community_references=%s",
        presentation_id, presentation.n_slides, len(presentation.file_paths or []),
        presentation.web_search, presentation.community_design_ids or [],
    )
